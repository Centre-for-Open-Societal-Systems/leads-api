...
#     <overlay>              overlay dir under apps/leads-api/overlays/   (e.g. staging)
...
OVERLAY_PATH="apps/leads-api/overlays/${OVERLAY}"
...
git commit -m "ci(leads-api): ${OVERLAY} image -> ${NEW_REF##*/}"
